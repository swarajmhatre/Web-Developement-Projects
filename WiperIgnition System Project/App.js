...
//Upper Switch
var switch1pt = new Project.Point(100, 226);
var switch1 = new Project.Switch(switch1pt, 25, false, "Ignition", "grey", context);
switch1.draw();
//Lower Switch
var switch2pt = new Project.Point(100, 384);
var switch2 = new Project.Switch(switch2pt, 25, false, "Wiper", "grey", context);
switch2.draw();
// Strand Support
var startpt = new Project.Point(570, 235);
var rectangle = new Project.Rect(startpt, 15, 120, context);
rectangle.draw();
//AND GATE
var gatestpt = new Project.Point(310, 280);
var gatecentpt = new Project.Point(360, 305);
...
strand2.draw();
//outercircle
var outercircle = new Project.Circle(480, 305, 25, 0, "grey", context);
outercircle.drawstatic();
//innercircle
var x = 492;
var y = 305;
var angle = 0;
var incircle = new Project.Circle(x, y, 10, angle, "yellow", context);
incircle.drawrotat();
//isanim vaiable
var isanim = false;
//Moseclick Function
